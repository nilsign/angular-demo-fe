...
Note, once the BE and the FE has been started locally, login as super admin user in order to be able to access most of
the implemented features, which are mainly user and role management related.
